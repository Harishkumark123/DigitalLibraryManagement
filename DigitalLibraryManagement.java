...
class DigitalLibraryManagement{
    ...
    public void admin_login()
    {
        ...
        loginto.put("Sai",3000);
        loginto.put("Harish",3001);
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Harish",2000);
        loginto.put("Kumar",2001);
        loginto.put("Sai",2002);
        loginto.put("sri",2003);
        loginto.put("krishna",2004);
        loginto.put("chinnu",2005);
